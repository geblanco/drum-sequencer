...
class LedClock(object):
    def __init__(self, config, sequencer, led_queue):
    ...
    def tick(self):
        ...
        for track_id in range(self.nof_displayed_tracks):
            target_track_id = track_id + self.sequencer._display_index
